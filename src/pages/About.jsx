                  ...
                  <div className="md:w-2/3 p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      <div className="flex space-x-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-navy-blue hover:text-white transition-all duration-300 transform hover:scale-110">
