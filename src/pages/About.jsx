...
const About = () => {
  ...
  const leadershipTeam = [
    {
      ...
      image: "/rizedigitalv2/images/james.jpg",
      expertise: ["Digital Strategy", "Google Ads", "SEO"],
      social: {
        x: "https://x.com/JamesCoyle",
        linkedin: "https://www.linkedin.com/in/james-coyle"
      }
    },
    {
      name: "Beau Tetreault",
      ...
      image: "/rizedigitalv2/images/Beau.jpg",
  ...
  const companyValues = [
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15l3-3m0 0l-3-3m3 3H7" />
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11h3m-3 4h3m-3-8h3" />
      </svg>`
    },
    {
    ...
    },
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10h.01M15 10h.01M12 14h.01" />
      </svg>`
    },
    {
  ...
  return (
    <>
      ...
      {/* Our Team Section - Professional design with enhanced image display */}
      <section ref={addToRefs} className="py-24 bg-gradient-to-b from-white to-gray-50 opacity-0 transition-opacity duration-1000">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            {leadershipTeam.map((leader, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                <div className="flex flex-col md:flex-row">
                  {/* Image Column - Enhanced professional styling */}
                  <div className="md:w-1/3 p-8 flex justify-center items-center bg-gradient-to-br from-gray-50 to-gray-100">
                    <div className="relative">
                      {/* Decorative elements */}
                      <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-blue-100"></div>
                      <div className="absolute -bottom-3 -right-3 w-6 h-6 rounded-full bg-accent-orange opacity-50"></div>
                      
                      {/* Enhanced circular image frame with better shadow and border */}
                      <div className="relative w-56 h-56 rounded-full overflow-hidden border-4 border-white shadow-xl" style={{ boxShadow: '0 0 25px rgba(0,0,0,0.1), 0 5px 10px rgba(0,0,0,0.05)' }}>
                        <img 
                          src={leader.image} 
                          alt={leader.name} 
                  ...
                  {/* Content Column - Enhanced professional layout */}
                  <div className="md:w-2/3 p-8 md:p-10 flex flex-col justify-center">
                    <div className="mb-4">
                      <h3 className="text-2xl font-bold text-dark-blue mb-1">{leader.name}</h3>
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {leader.expertise.map((skill, i) => (
                        <span key={i} className="px-3 py-1 bg-blue-50 text-navy-blue text-sm font-medium rounded-full">
                          {skill}
                        </span>
                      ))}
                    </div>
                    
                    {/* Bio with enhanced typography and readability */}
                    <p className="text-gray-600 leading-relaxed mb-6 text-base">{leader.bio}</p>
                    
                    {/* Enhanced contact button section */}
                    <div className="mt-auto flex items-center justify-between">
                      <div className="flex space-x-4">
                        <a href={leader.social.x} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-navy-blue hover:text-white transition-all duration-300 transform hover:scale-110">
                        ...
                        <a href={leader.social.linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-navy-blue hover:text-white transition-all duration-300 transform hover:scale-110">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"></path>
                          </svg>
                        </a>
                      </div>
                      <Link to="/contact" className="px-6 py-3 bg-navy-blue text-white font-medium rounded-lg hover:bg-dark-blue transition-all duration-300 shadow-md hover:shadow-lg">
                        Contact
                      </Link>
                    </div>
                  </div>
